    ...
    <div class="col-full">
        <div class="featured">
            <div class="featured__column featured__column--big">
                <div class="entry" style="background-image:url('images/{{$home1->image}}');">
            ...
            <div class="featured__column featured__column--small">
                ...
                <div class="entry" style="background-image:url('images/{{$home2->image}}');">
                ...
                <div class="entry" style="background-image:url('images/{{$home3->image}}');">
